 ...
 * Generated for Laravel 6.16.0 on 2020-02-21 17:54:57.
 *
...
namespace App {
    ...
    /**
    * @method Collection|Booking[]|Booking create($attributes = [])
    * @method Collection|Booking[]|Booking make($attributes = [])
    */
    class BookingFactoryBuilder extends FactoryBuilder {}
}
namespace App {
    ...
    /**
    * @method Collection|Room[]|Room create($attributes = [])
    * @method Collection|Room[]|Room make($attributes = [])
    */
    class RoomFactoryBuilder extends FactoryBuilder {}
}
namespace App {
